...
import useImgUpload from '../components/hooks/useImgUpload'
...
const Post = () => {
  ...
  const writeSubmit = () => {
    ...
    formData.append("type",conimal.type);
    ...
    <>
      ...
      <label htmlFor="imgFile" />
        ...
        <input type="File" 
          ...
          multiple 
        />
        <input type="text" name="title" value={conimal.title || ""} onChange={onChangeHandler} placeholder="제목"/>
        <select name="type" value={conimal.type || ""} onChange={onChangeHandler} >
            <option value="전체">골라주세요</option>
